        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">{{ __('admin.hello') }},
                  <span class="user-name text-bold-700">{{ \Illuminate\Support\Facades\Auth::guard('student')->user()->name }}</span>
                </span>
                  ...
                  <img src="{{ asset('adminpanel/app-assets/images/portrait/small/avatar-s-19.png') }}" alt="avatar"><i></i></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i class="ft-user"></i> Edit Profile</a>
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('student.logout') }}"><i class="ft-power"></i> Logout</a>
                        </div>
                    </li>
