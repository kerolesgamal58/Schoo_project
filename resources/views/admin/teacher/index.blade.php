                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin.teachers') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.teachers') }}</h4>
                                            ...
                                            <tbody>
                                                @foreach($teachers as $teacher)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" style="color: white" href="{{ route('teacher.edit', $teacher->id) }}">{{ __('admin.edit') }}</a>
                                                            <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('teacher.delete', $teacher->id) }}">{{ __('admin.delete') }}</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
