                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin.edit_student') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.edit_student') }}</h4>
                            ...
                            <div class="card-body">
                                <form class="form" method="post" action="{{ route('student.update', $student->id) }}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="payed" value="{{ $student->payed }}">
                                                    @error('payed')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="class_room_id">
                                                    ...
                                                    @foreach(\App\Models\ClassRoom::all() as $class_room)
                                                        <option value="{{ $class_room->id }}" @if($student->class_room_id == $class_room->id) selected @endif>{{ $class_room->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('class_room_id')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" id="schoolYear" name="school_year_id">
                                                    ...
                                                    @foreach(\App\Models\SchoolYear::all() as $school_year)
                                                        <option value="{{ $school_year->id }}" @if($student->school_year_id == $school_year->id) selected @endif>{{ $school_year->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="select2-placeholder-multiple form-control" name="subjects[]" multiple id="multi_placehodler">
                                                        @foreach(\App\Models\Subject::where('school_year_id', $student->school_year_id)->get() as $subject)
                                                            <option value="{{ $subject->id }}" @if( in_array($subject->id, App\Helper\getStudentSubject($student->id)) ) selected @endif>{{ $subject->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('subjects')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
