                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.students') }}</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ __('admin.payed') }}</th>
                                                <th>{{ __('admin.class_room') }}</th>
                                            ...
                                            <tbody>
                                                @foreach($students as $student)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" style="color: white" href="{{ route('student.edit', $student->id) }}">{{ __('admin.edit') }}</a>
                                                            <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('student.delete', $student->id) }}">{{ __('admin.delete') }}</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
