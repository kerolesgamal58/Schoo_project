...
<script src="{{ asset('adminpanel/app-assets/vendors/js/charts/chartist.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('adminpanel/app-assets/vendors/js/charts/chartist-plugin-tooltip.min.js') }}"
