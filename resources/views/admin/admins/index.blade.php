                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($admins as $admin)
                                                <tr>
                                                    ...
                                                    <td>{{ $admin->email }}</td>
                                                    <td>
                                                        <a class="btn btn-primary" style="color: white" href="{{ route('admin.edit', $admin->id) }}">{{ __('admin.edit') }}</a>
                                                        <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('admin.delete', $admin->id) }}">{{ __('admin.delete') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            @else
