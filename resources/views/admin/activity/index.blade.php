        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{ __('admin.activities') }}</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{ __('admin.home') }}</a>
                                </li>
                                <li class="breadcrumb-item active">{{ __('admin.activities') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($activities as $activity)
                                                <tr>
                                                    ...
                                                    <td>{{ $activity->name }}</td>
                                                    <td>
                                                        <a class="btn btn-primary" style="color: white" href="{{ route('activity.edit', $activity->id) }}">{{ __('admin.edit') }}</a>
                                                        <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('activity.delete', $activity->id) }}">{{ __('admin.delete') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            @else
