                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin.edit_class_room') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.edit_class_room') }}</h4>
                            ...
                            <div class="card-body">
                                <form class="form" method="post" action="{{ route('class_room.update', $class_room->id) }}">
                                    @csrf
                                    <input type="hidden" value="{{ $class_room->id }}" name="id">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" value="{{ $class_room->name }}">
                                                    @error('name')
