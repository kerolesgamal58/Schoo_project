                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin.subjects') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.subjects') }}</h4>
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($subjects as $subject)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" style="color: white" href="{{ route('subject.edit', $subject->id) }}">{{ __('admin.edit') }}</a>
                                                        <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('subject.delete', $subject->id) }}">{{ __('admin.delete') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            @else
