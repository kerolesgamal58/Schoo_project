                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin.parents') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.parents') }}</h4>
                                            ...
                                            <tbody>
                                                @foreach($parents as $parent)
                                                    <tr>
                                                        ...
                                                        <td>{{ $parent->email }}</td>
                                                        <td>
                                                            @if($parent->relation == 'father') {{ __('admin.father') }}
                                                            @elseif($parent->relation == 'mother') {{ __('admin.mother') }}
                                                            @else {{ __('admin.uncle') }}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-primary" style="color: white" href="{{ route('parent.edit', $parent->id) }}">{{ __('admin.edit') }}</a>
                                                            <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('parent.delete', $parent->id) }}">{{ __('admin.delete') }}</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
