                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin.school_years') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin.school_years') }}</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            @foreach($school_years as $school_year)
                                                <tr>
                                                    <th scope="row">{{ $school_year->id }}</th>
                                                    <td>{{ $school_year->name }}</td>
                                                    <td>{{ $school_year->fee }}</td>
                                                    <td>
                                                        <a class="btn btn-primary" style="color: white" href="{{ route('school_year.edit', $school_year->id) }}">{{ __('admin.edit') }}</a>
                                                        <a class="btn btn-danger deleteItem" style="color: white" href="{{ route('school_year.delete', $school_year->id) }}">{{ __('admin.delete') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            @else
