...
Route::group(['prefix' => 'teacher', 'middleware' => 'guest:teacher'], function (){
    Route::get('login', [AuthController::class, 'getLogin'])->name('teacher.get_login');
    Route::post('login', [AuthController::class, 'postLogin'])->name('teacher.post_login');
});

Route::group(['prefix' => 'teacher', 'middleware' => 'auth:teacher'], function(){

    Route::get('/', [AuthController::class, 'index'])->name('teacher.home');
    Route::get('logout', [AuthController::class, 'logout'])->name('teacher.logout');
    Route::get('/class/{id}', [ClassController::class, 'showClass'])->name('teacher.class');
    Route::get('/chat/{id}', [ClassController::class, 'showChat'])->name('teacher.chat');
