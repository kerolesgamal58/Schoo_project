...
Route::group(['prefix' => 'student', 'middleware' => 'guest:student'], function (){
    Route::get('login', [AuthController::class, 'getLogin'])->name('student.get_login');
    Route::post('login', [AuthController::class, 'postLogin'])->name('student.post_login');
});

Route::group(['prefix' => 'student', 'middleware' => 'auth:student'], function(){

    Route::get('/', [AuthController::class, 'index'])->name('student.home');
    Route::get('logout', [AuthController::class, 'logout'])->name('student.logout');
    Route::get('/class/{id}', [ClassController::class, 'showClass'])->name('student.class');
    Route::get('/chat/{id}', [ClassController::class, 'showChat'])->name('student.chat');
